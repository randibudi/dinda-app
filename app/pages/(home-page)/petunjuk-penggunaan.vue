      ...
      <div>
        ...
        <UCard class="mb-6 shadow-lg">
          <p class="mb-5 text-gray-700">
            Agar dapat menggunakan e-learning DINDA secara maksimal, perhatikan
        ...
        <div class="rounded-xl border border-sky-200 bg-sky-50 p-5">
          ...
          <p class="text-gray-700">
            ...
            koneksi internet yang stabil dan lingkungan yang nyaman saat
            menggunakan aplikasi. Jangan ragu untuk mengulang materi jika
            diperlukan.
          </p>
        </div>
      </div>
